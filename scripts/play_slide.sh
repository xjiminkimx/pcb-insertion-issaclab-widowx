#!/usr/bin/env bash
# Play / evaluate the Slide-phase checkpoint from this workspace's logs/.
...
CKPT_DIR="${WORKSPACE_DIR}/logs/rl_games/widowx_pcb_slide/nn"
DEFAULT_CKPT_NAME="widowx_pcb_slide.pth"
NUM_ENVS=16
